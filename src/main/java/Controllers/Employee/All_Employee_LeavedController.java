...
public class All_Employee_LeavedController implements Initializable {
    ...
    @FXML private TableView<LeavedEmployeeDetails> tableEmployee;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_id;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_name;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_prn_no;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_phonenumber;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_emgtel;
    @FXML private TableColumn<LeavedEmployeeDetails, String> col_leav_date;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        data = FXCollections.observableArrayList(EmployeeDataStore.leavedEmployees);
