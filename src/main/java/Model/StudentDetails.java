...
/**
 * Model class for a student living in the hostel.
 * Fields: name, prnNo (unique), address, email, contactNumber,
 *         guardianName, guardianContact, hostelBlock (B1-B4), fees.
 */
public class StudentDetails {
    ...
    private StringProperty phoneNumber;   // contactNumber
    private StringProperty address;
    private StringProperty guardName;     // guardianName
    private StringProperty guardTel;      // guardianContact
    private StringProperty hostelBlock;
    private StringProperty fees;

    public StudentDetails(String id, String name, String prnNo, String email,
                          String phoneNumber, String address,
                          String guardName, String guardTel,
                          String hostelBlock, String fees) {
    ...
    public String getFees()        { return fees.get(); }
    ...
    public void setFees(String v)        { fees.set(v); }

    // â”€â”€ Properties (for TableView binding) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public StringProperty feesProperty()        { return fees; }
}
